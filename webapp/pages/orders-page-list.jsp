...
<!--<link rel="stylesheet" href="${pageContext.request.contextPath}/${pageContext.request.contextPath}/https://cdn.jsdelivr.net/gh/MSyiilii/ssm_adminlte@1.0/plugins/timepicker/bootstrap-timepicker.min.css">-->
...
<!-- bootstrap color picker -->
<!-- bootstrap time picker -->
<!--<script src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/https://cdn.jsdelivr.net/gh/MSyiilii/ssm_adminlte@1.0/plugins/timepicker/bootstrap-timepicker.min.js"></script>-->
<!-- Bootstrap WYSIHTML5 -->
<!--bootstrap-markdown-->
<!-- CK Editor -->
<!-- InputMask -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a
							href="${pageContext.request.contextPath}/orders/findAll.do">数据管理</a></li>
...
<%--										</button>--%>
	...
	<script
		src="https://cdn.jsdelivr.net/gh/MSyiilii/ssm_adminlte@1.0/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.js"></script>
	<script
		src="https://cdn.jsdelivr.net/gh/MSyiilii/ssm_adminlte@1.0/plugins/bootstrap-datetimepicker/locales/bootstrap-datetimepicker.zh-CN.js"></script>
	<script>
